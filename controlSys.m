classdef controlSys <handle
    ...
    methods (Access=public)
        ...
        %main control to decide which direction button to be visible
        ...
        %close visible position of Buttons
